...
MyString readString() – читает с клавиатуры строку
...
Внимание: создавайте переменную для чтения данных с консоли (BufferedReader или Scanner) внутри
каждого метода
*/
...
public class ConsoleReader
{
    ...
    {
        int n = Integer.parseInt(ConsoleReader.readString());
        return n;
    }
