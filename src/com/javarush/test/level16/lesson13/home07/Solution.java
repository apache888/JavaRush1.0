...
1.1. List<MyString> steps хранит последовательность действий, которое каждый игрок выполняет
 от 0 до последнего.
...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            try
            {
                for (String act: OnlineGame.steps)
                {
                    System.out.println(getName() + ":" + act);
