...
2.1. Вызвать конструктор суперкласса с параметром MyString - номером созданной нити.
...
4. Пока количество созданных нитей меньше Solution1.count метод run должен:
    ...
    public static class GenerateThread extends Thread{
        ...
        public void run() {
            while (countCreatedThreads < count){
                GenerateThread thred = new GenerateThread();
