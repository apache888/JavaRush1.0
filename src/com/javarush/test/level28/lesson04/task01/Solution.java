...
В классе SolutionDraft создайте публичный статический класс AmigoThreadFactory, реализующий интерфейс ThreadFactory
...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        public Thread newThread(Runnable r)
        {
            ...
            Thread thread = new Thread(r, Thread.currentThread().getThreadGroup().getName() +
                    "-pool-" + factoryNumber +
                    "-thread-" + threadNumber);
