...
3. В статическом методе reset класса Solution1:
3.1. Считать с консоли параметр типа MyString. Параметр может быть "plane" или "helicopter".
    ...
    public static void reset() {
        ...
        try{
            ...
            if (str.equals("helicopter")){
                ...
                int qnty = Integer.parseInt(reader.readLine());
                result = new Plane(qnty);
            }
        }catch (IOException e){}
        finally
        {
