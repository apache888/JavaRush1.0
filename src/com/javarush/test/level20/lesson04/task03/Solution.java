...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        //Recreating the instance by reading the serialized object price store
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("singleton.tmp"));
        Singleton singleton = (Singleton) ois.readObject();
        ois.close();

        //Recreating the instance AGAIN by reading the serialized object price store
...
//        метод обязательный для сериализации Singleton
