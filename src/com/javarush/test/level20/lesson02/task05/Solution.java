...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            File your_file_name = new File("g:/tmp/test.tmp");
...
// сохранить поле number у string1/2
        ...
        public void load(InputStream inputStream) throws Exception {
            //implement this method - реализуйте этот метод
//  выгружать number и по нему устанавливать countStrings для выгружаемого объекта, и
//            и в конце вернуть прежнее значение countStrings
            BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
            int tempCount = countStrings;
            countStrings = Integer.parseInt(reader.readLine())-1;
            this.string1 = new String();
            countStrings = Integer.parseInt(reader.readLine())-1;
            this.string2 = new String();
            countStrings = tempCount;
            reader.close();
        }
    }
