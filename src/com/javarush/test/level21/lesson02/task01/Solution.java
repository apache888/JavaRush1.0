...
public class Solution {
    ...
    public static void print(byte[] bytes) {
        ...
        System.out.println();
//        System.out.println(Integer.toBinaryString(256 + (int) bytes[0]) + " " + Integer.toBinaryString(256 + (int) bytes[1])
//        + " " + Integer.toBinaryString(256 + (int) bytes[2]).substring(1) + " " + Integer.toBinaryString(256 + (int) bytes[3]).substring(1));
////
//        StringBuilder builder = new StringBuilder();
//        for (int i = 0; i < bytes.length; i++){
//            if (bytes[i] >= 0 && bytes[i] < 32)
//            {
//                builder.append(Integer.toBinaryString((256 + bytes[i])).substring(1)+ " ");
//            } else {
//                builder.append(Integer.toBinaryString(bytes[i] & 0xff)+ " ");
//            }
//        }
